    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
        ...
        <motion.div
          ...
          className="md:hidden fixed inset-0 glass-panel bg-white/80 flex flex-col justify-center items-center pt-24 pb-12 px-6"
        >
          <nav className="flex flex-col gap-8 text-2xl font-editorial text-center w-full">
            <a href="#work" onClick={() => setMobileMenuOpen(false)} className="py-2">Work</a>
